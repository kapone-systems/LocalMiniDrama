...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版 AppImage：LocalMiniDrama-x.x.x-linux-x64.AppImage"
echo "  完整版 deb     ：LocalMiniDrama-x.x.x-linux-x64.deb"
echo "  纯净版 AppImage：LocalMiniDrama-Lite-x.x.x-linux-x64.AppImage"
echo "  纯净版 deb     ：LocalMiniDrama-Lite-x.x.x-linux-x64.deb"
echo ""
