...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版 AppImage：DramaDesk-x.x.x-linux-x86_64.AppImage"
echo "  完整版 deb     ：DramaDesk-x.x.x-linux-amd64.deb"
echo "  纯净版 AppImage：DramaDesk-Lite-x.x.x-linux-x86_64.AppImage"
echo "  纯净版 deb     ：DramaDesk-Lite-x.x.x-linux-amd64.deb"
echo ""
