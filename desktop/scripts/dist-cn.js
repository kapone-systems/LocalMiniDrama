...
console.log('  完整版安装包：DramaDesk-Setup-x.x.x.exe');
console.log('  完整版便携版：DramaDesk-x.x.x.exe');
console.log('  纯净版安装包：DramaDesk-Lite-Setup-x.x.x.exe');
console.log('  纯净版便携版：DramaDesk-Lite-x.x.x.exe\n');
process.exit(0);
